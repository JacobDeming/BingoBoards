...
spaces = [
  ...
  "Nancy Drew defiles a dead/unconcious body",
  ...
  "Nancy Drew tells a character off for committing a crime she has previously committed",
  ...
  "We play as someone other than Nancy",
  ...
  "Grue and/or Avery make a joke which later turns out to be true",
  "Nancy starts an investigaation without being asked",
  "Emergency services get involved",
  "Game contains a direct reference to previous titles",
  "Someone creepily flirts with Nancy",
  "Puzzle blocks progress but has nothing to do with the investigation",
  "Game refuses to progress due to an obscure flag not being met"
];
